...
int main() 
{
    ...
    int samples = 100000, iteration = 80000;
    ofstream logfile;
    ...
    while(iteration < samples) {
        ...
        pcg32 rng(iteration);
        std::uniform_int_distribution<int> uniform_dist_agent(1, 20);
        std::uniform_int_distribution<int> uniform_dist_item(1, 40);
        ...
        while( (minBundlePrice < EFMaxBundlePrice) && doubleIsEqual(minBundlePrice, EFMaxBundlePrice, EPS)==false ) {
            ...
            while(1) {
                ...
                vector<int> predAgentToItem(m,-1), predItemToAgent(n,-1); //predAgent = preceding agent to an item
                ...
                if((minBundlePrice < EFMaxBundlePrice) && doubleIsEqual(minBundlePrice, EFMaxBundlePrice, EPS)==false);
                else break;
